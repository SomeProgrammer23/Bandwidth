Shader "Custom/OutlineDistort"  //Taught by Morgan James
{
    Properties // Variables
    {
        _DistortColor("Distort Colour", Color) = (1,1,1,1) // Distort Colour Property
        _BumpAmt("Distortion", Range(0, 128)) = 10 // Distort Amount Property
        _DistortTex("Distort Texture (RGB)", 2D) = "white" {} // Distort Texture Property
        _BumpMap("Normal Map", 2D) = "bump" {} // Distort Map Property
